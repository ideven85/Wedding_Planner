(function (g, h, C) {
    ...
    function Ba(a, b) {
        ...
        if (.01 > Math.random()) try {
            var d = a && a.message || "";
            (c = -1 < d.indexOf("network error occurred") || -1 < d.indexOf("send beacon") && -1 < d.indexOf("Content Security Policy")) || (new oa).log("jserrs", ca, a.message, b, J.href, "", "string" === typeof a.stack && a.stack.replace(/\n/g, "\\n"))
        } catch (e) {
        }
    }
    ...
    function yb(a, b, c, d, e) {
        ...
        function n(a, b) {
            ...
            for (var c = 0; c < b.length; c++) O(a, b.charCodeAt(c))
        }

        function cb(a, b) {
            t(a,
                b.length);
            for (var c = 0; c < b.length; c++) t(a, b.charCodeAt(c))
        }

        function Ca(a) {
            if (!a.nodeName) return a[H] = -1, null;
            var b = +a[H];
            ...
            c = 64;
            var d = 0, e = p.getElementParent(a), l = e && e[H] ? e[H] : 0;
            0 > l && (l = 0);
            var f = a.nodeName.toUpperCase(), m = Bb[f];
            m || (c |= 2);
            var r = p.getElementNeighborPosition(a);
            r || (c |= 4);
            var X = p.getElementRegion(a);
            (e = e ? p.getElementRegion(e) : null) && X[0] == e[0] && X[1] == e[1] && X[2] == e[2] &&
            X[3] == e[3] && (c |= 8);
            Q[b].pos = X[0] + "x" + X[1];
            Q[b].size = X[2] + "x" + X[3];
            a.id && "string" == typeof a.id && (c |= 32);
            (e = p.calcTextChecksum(a)) && (c |= 16);
            var g = p.calcAttribChecksum(a);
            g && (d |= 2);
            a:{
                var w = p.getElementChildren(p.getElementParent(a), a.tagName);
                for (var D = 0; D < w.length; D++) if ((!w[D].id || "string" != typeof w[D].id) && p.calcAttribChecksum(w[D]) == g && p.calcTextChecksum(w[D]) == e) {
                    w = !0;
                    break a
                }
                w = !1
            ...
            if (w) {
                c |= 1;
                var h = p.calcChildrenChecksum(a)
            }
            w = [];
            q(w, 1);
            t(w, b);
        ...
        function Na(a, b, c, d, e, l) {
            for (var f; c && (f = p.getElementSize(c)) && (!f[0] || !f[1]);) c = p.getElementParent(c);
            if (!c) return null;
            f = c[H];
            if (!f || 0 > f) return null;
            var m = {mousemove: 2, click: 32, dblclick: 33, mousedown: 4, mouseup: 30, touch: 12}[b];
            if (!m) return null;
            var r = p.getElementXY(c);
            c = [];
            q(c, m);
            t(c, a);
            t(c, f);
            t(c, Math.max(0, d[0] - r[0]));
            t(c, Math.max(0, d[1] - r[1]));
            /^mouse(up|down)|click$/.test(b) && (a = e || l, q(c, 2 > a ? 1 : a == (e ?
                2 : 4) ? 4 : 2));
            return c
        }
        ...
        function R(a) {
            var b = a[H];
            if (!b || 0 > b || !/^INPUT|SELECT|TEXTAREA$/.test(a.nodeName) || !a.form || ea(a.form)) return null;
            ...
            for (var e = -1, l = a.form.elements, f = l.length, m = 0, r = 0; m < f; m++) if (l[m].name == a.name) {
                if (l[m] == a) {
                    e = r;
                    break
                }
        ...
        function T(a, b) {
            ...
            if (0 > c) return null;
            for (var d = b.elements, e = d.length, l = [], m = 0; m < e; m++) if (!p.isEmptyField(d[m])) {
                var r = d[m][H];
                r && 0 < r && f.mergeArrays(l, [r])
            }
            d = [];
            q(d, 11);
            t(d, a);
        ...
        function M(a) {
            if (a[H]) a:{
                ...
                if (0 < c) {
                    ...
                    var e = Q[c], l = a[0] + "x" + a[1], f = a[2] + "x" + a[3];
                    l != e.pos && (e.pos = l, q(d, 9), t(d, b), t(d, c), t(d, a[0]), t(d, a[1]));
                    f != e.size && (e.size = f, q(d, 10), t(d, b), t(d, c), t(d, a[2]), t(d, a[3]));
                    if (d.length) {
                        b = d;
                        break a
                    }
                ...
                b = null
            } else (b = p.getElementParent(a)) && M(b), a[H] = db, Q[db] = {}, db++, b = Ca(a), xa.append(b, void 0), b = R(a);
            xa.append(b, void 0)
        }
        ...
        function Y(a) {
            ...
            if (b && "SCROLLBAR" != b.nodeName) {
                if (/^INPUT|SELECT|TEXTAREA|BUTTON$/.test(b.tagName)) if (b[H]) M(b); else {
                    var c = b.form;
                    if (c) {
                        c = c.elements;
                        for (var d = c.length, e = 0; e < d; e++) /^INPUT|SELECT|TEXTAREA|BUTTON$/.test(c[e].tagName) && !c[e][H] && M(c[e])
                    } else M(b)
                } else M(b);
                K(Na, [m(), a.type, b, G.getPos(a), a.which,
                    a.button])
            }
        }
        ...
        function pa(a) {
            var b = l(), c = b - W;
            if (!(10 > c)) {
                var d = G.getPos(a), e = eb[0] - d[0], f = eb[1] - d[1];
                e = e * e + f * f;
                0 >= e || 16 > e && 100 > c || 20 > c && 256 > e || (W = b, eb = d, Y(a))
            }
        }

        function ha() {
            var a = p.getDocumentScroll(), b = l();
            10 > b - mb || 10 > Math.abs(a[0] - fb[0]) && 10 > Math.abs(a[1] - fb[1]) || (mb = b, fb = a, K(x, [m(), a]))
        }
        ...
        function ka(a) {
            if (a = G.getTarget(a)) {
                ...
                if (a.localId) {
                    if (b = gb[a.localId], !b || 10 > Math.abs(c[0] - b[0]) && 10 > Math.abs(c[1] - b[1])) return
                } else {
                    for (; gb[b];) b =
                        Math.random();
                    a.localId = b
        ...
        function N() {
            K(Oa, [m(), p.getViewportSize(), p.getDocumentSize()])
        }
        ...
        function ta(a) {
            ...
            var b = "password" === a.type ||
                Ra.test(a.name) || Ra.test(a.id), c = f.reduce(function (b, c) {
        ...
        function ia(a, b, c) {
            a = G.getTarget(a);
            var d = ta(a);
            d.ignore || !d.forceRecord && (d.isPrivate && e.get("isEU") || L(a)) || (M(a), K(C, [m(), b, c, a, d.privateFlag]))
        }

        function S(a) {
            var b = a.keyCode, c = ja(a);
            if ({
                3: 1,
                8: 1,
                9: 1,
                ...
                144: 1,
                145: 1
            }[b] || 112 <= b && 123 >= b || 96 <= b && 105 >= b || c & 16) 19 == b && 4 == (c & -17) && (b = 144), ia(a, b, c | 16), na = !1, f.setTimeout(function () {
                na = !0
            }, 1, "wvl.keyDown"), !(67 == b && c & 4) || c & 1 || c & 2 || ya()
        }

        function la(a) {
            na && !oa && 0 !== a.which && (ia(a, a.charCode || a.keyCode, ja(a)), oa = !0, f.setTimeout(function () {
                oa = !1
            }, 1, "vwl.keyPress"))
        }
        ...
        function wa() {
            ...
            if ("string" == typeof b) {
                ...
                if (c) {
                    a = ta(c).privateFlag || L(c, !0);
                    c = c.getElementsByTagName("*");
                    for (var d = 0; d < c.length && !a;) a = ta(c[d]).privateFlag || L(c[d], !0), d++;
                    b != ca && (ca = b, b = a ? f.map(function () {
                        return Fa.obfuscatedSymbol
                    }, b.split("")).join("") : b, K(Pa, [m(), b]))
                }
            }
        }

        function ya() {
            qa || (qa = !0, ca && K(A, [m()]), f.setTimeout(function () {
                qa =
                    !1
            }, 1, "wvl.copy"))
        }
        ...
        function ba(a) {
            if ((a = G.getTarget(a)) && /^INPUT|SELECT|TEXTAREA|BUTTON$/.test(a.tagName)) {
                if (a[H]) M(a); else {
                    ...
                    if (b) {
                        b = b.elements;
                        for (var c = b.length, d = 0; d < c; d++) /^INPUT|SELECT|TEXTAREA|BUTTON$/.test(b[d].tagName) && !b[d][H] && M(b[d])
                    } else M(a)
                }
                K(B, [m(), a])
            }
        ...
        function V(a) {
            if ((a = G.getTarget(a)) && !sa(a) && !L(a) && /^INPUT|SELECT|TEXTAREA$/.test(a.tagName)) {
                var b = ta(a), c = /^(checkbox|radio)$/.test(a.type) ? a.checked : a.value;
                c = b.recordData ? c : f.map(function () {
                    return Fa.obfuscatedSymbol
                }, c.split("")).join("");
                M(a);
                K(P, [m(), a, c, b.privateFlag])
            }
        }

        function Ha(a) {
            if ((a = G.getTarget(a)) && !ea(a) && "FORM" == a.nodeName) {
        ...
        function hb(a) {
            ...
            if (a.touches && a.touches.length) {
                ...
                if (b && b != h) {
                    M(b);
                    for (var c = 0; c < a.touches.length; c++) K(Na, [m(), "touch", b, [a.touches[c].pageX, a.touches[c].pageY], 0, 0])
                }
            }
        }
        ...
        function Sa(a) {
            ...
            if (b) {
                ...
                c && (M(b), K(v, [m(), b, G.getPos(a), c]))
            }
        }

        function nb(a) {
            (a = G.getTarget(a)) && "BODY" == a.tagName && xa.append([], !0)
        }

        var xa = new Ta({
            protocol: a, globalConfig: e, counterId: b, counterType: c, meta: {
                url: y().href, hitId: d, timezone: Ia,
                timestamp: Ja
            }
        }), ob = p.getBody(), Bb = {
            A: 1,
        ...
        r(0);
        var db = 1, W = 0, eb = [0, 0], mb = 0, fb = [0, 0], gb = {}, Ra = /^(password|passwd|pswd)$/, na = !0, oa = !1,
            ca = "", qa = !1, Ga = !0, ra = l(), H = "metrikaId_" + Math.random(), Q = {},
            ma = ":submit" + Math.random();
        if (!f.isMetrikaPlayer()) {
            k.on(h, "mousemove", pa);
            k.on(h, "click,dblclick,mousedown", Y);
            k.on(h, "mouseup", Z);
            k.on(g, "scroll", ha);
            if ("onmousewheel" in h) k.on(h, "mousewheel", Sa); else k.on(h, "wheel", Sa);
            k.on(g, "beforeunload",
                fa);
            if (!Db) k.on(g, "unload", fa);
            k.on(g, "resize", N);
            k.on(h, "keydown", S);
            k.on(h, "keypress", la);
            k.on(h, "copy", ya);
            k.on(h, "touchmove,touchstart", hb);
            if (ob) k.on(h, "mouseleave", nb);
            h.attachEvent && !g.opera ? (k.on(h, "focusin", aa), k.on(h, "focusout", I)) : (k.on(g, "focus", w), k.on(g, "blur", D), k.on(h, "blur", D));
            h.addEventListener ? (k.on(h, "scroll", ka), k.on(h, "focus", ba), k.on(h, "blur", U), k.on(h, "change", V), k.on(h, "submit", Ha)) : h.attachEvent && (k.on(h, "focusin", ba), k.on(h, "focusout", U), function () {
                for (var a = h.getElementsByTagName("form"),
                         b = 0; b < a.length; b++) {
                    for (var c = a[b].getElementsByTagName("*"), d = 0; d < c.length; d++) if (/^INPUT|SELECT|TEXTAREA$/.test(c[d].tagName)) k.on(c[d], "change", V);
                    k.on(a[b], "submit", Ha)
                }
            }());
            (function () {
                ...
                if (a.length) for (var b = 0; b < a.length; b++) {
                    var c = a[b].submit;
                    if ("function" === typeof c || "object" === typeof c && /^\s*function submit\(\)/.test(String(c))) a[b][ma] = c, a[b].submit = function () {
                        Ha({target: this});
                        return this[ma]()
                    }
                }
            })();
            "0:0" !== p.getDocumentScroll().join(":") && ha();
            N()
        }
        return {
            start: function () {
            ...
            stop: function () {
                ...
                k.un(h, "mousedown", Y);
                k.un(h, "mouseup", Z);
                k.un(h, "mousewheel", Sa);
                k.un(h, "wheel", Sa);
                k.un(g, "scroll", ha);
                k.un(g, "beforeunload", fa);
                k.un(g, "unload", fa);
                k.un(g, "resize", N);
                k.un(h, "keydown", S);
                k.un(h, "keypress", la);
                k.un(h, "copy", ya);
                k.un(h, "touchmove", hb);
                k.un(h, "touchstart", hb);
                ob && k.un(h, "mouseleave", nb);
                k.un(h, "focusin", aa);
                k.un(h, "focusout", I);
                k.un(g, "focus", w);
                k.un(g, "blur", D);
                ...
                h.removeEventListener ?
                    (k.un(h, "scroll", ka), k.un(h, "focus", ba), k.un(h, "blur", U), k.un(h, "change", V), k.un(h, "submit", Ha)) : h.detachEvent && (k.un(h, "focusin", ba), k.un(h, "focusout", U), function () {
                    for (var a = h.getElementsByTagName("form"), b = 0; b < a.length; b++) {
                        for (var c = a[b].getElementsByTagName("*"), d = 0; d < c.length; d++) /^INPUT|SELECT|TEXTAREA$/.test(c[d].tagName) && k.un(c[d], "change", V);
                        k.un(a[b], "submit", Ha)
                    }
                }());
                (function () {
                    for (var a = h.getElementsByTagName("form"), b = 0; b < a.length; b++) a[b][ma] && (a[b].submit = a[b][ma])
                })()
                ...
                function c() {
                    ...
                    k.un(g, "load", c);
                    for (var e = a.split(/\n/), l = y().href, f = /regexp:/, m = 0; m < e.length; m++) {
                        var r = e[m];
                        if (r) if (f.test(r)) {
                            r = Ka(r.replace(f, ""));
                            try {
                ...
                if (l && 19E4 < ("" + l.innerHTML).length) return !1;
                var f = g.XMLHttpRequest ? new g.XMLHttpRequest : new ActiveXObject("Msxml2.XMLHTTP"),
                    m = p.getDocumentCharset(), r = "text/html" + (m ? ";charset\x3d" + m : ""),
                    t = new Eb({protocol: a, counterId: b, counterType: c});
                if ("html" === e) return e = new RegExp("\x3cscript [^\x3e]*?//" + E.host.replace(/\./g, "\\\\.") + "/watch/.*?\x3c/script\x3e", "gi"), t.sendContent(p.getDocumentHTML().replace(e, ""), r, d, Ia, Ja), !0;
                f && (f.open("get", y().href, !0), f.onreadystatechange = u(function () {
                    if (4 ===
                        f.readyState) {
                        var a = f.getResponseHeader("content-type") || "";
                        m && -1 === a.indexOf("charset\x3d") && (a = r);
                        t.sendContent(f.responseText, a, d, Ia, Ja)
                    }
                }, "updatePage.1"), f.overrideMimeType && m && f.overrideMimeType(r), f.send(null));
                return !0
            }, "uploadPage")
        }
    }
    ...
    function ja() {
        return 0 == y().hostname.search(/^(.*\.)?((yandex(-team)?)\.(com?\.)?[a-z]+|(auto|kinopoisk|beru)\.ru|ya\.(ru|cc)|yadi\.sk|yastatic\.net|.*\.yandex)$/)
    }
    ...
    function pb(a) {
        return Ka(a && a.innerHTML && a.innerHTML.replace(/<\/?[^>]+>/gi, ""))
    }
    ...
    function qb(a, b) {
        ...
        if (!a || !b) return !1;
        var d = [];
        for (c = 0; c < b.length; c++) d.push(b[c].replace(/\^/g, "\\^").replace(/\$/g, "\\$").replace(/\./g, "\\.").replace(/\[/g, "\\[").replace(/\]/g,
    ...
    function rb() {
        ...
        if (b && (c = b.navigationStart)) for (d = [b.domainLookupEnd - b.domainLookupStart, b.connectEnd - b.connectStart, b.responseStart - b.requestStart, b.responseEnd - b.responseStart, b.fetchStart - c, b.redirectEnd - b.redirectStart, b.redirectCount || a.navigation && a.navigation.redirectCount], d.push(b.domInteractive && b.domLoading ? b.domInteractive - b.domLoading : null), d.push(b.domContentLoadedEventStart && b.domContentLoadedEventEnd ? b.domContentLoadedEventEnd -
            b.domContentLoadedEventStart : null), d.push(b.domComplete ? b.domComplete - c : null), d.push(b.loadEventStart ? b.loadEventStart - c : null), d.push(b.loadEventStart && b.loadEventEnd ? b.loadEventEnd - b.loadEventStart : null), d.push(b.domContentLoadedEventStart ? b.domContentLoadedEventStart - c : null), a = 0; a < d.length; a++) b = d[a], null !== b && (0 > b || 36E5 < b) && (d[a] = null);
        return d
    }

    function Hb(a) {
        var b = [], c = a._lastPerformanceTiming, d = rb(), e;
        if (c) {
            var f = 0;
    ...
    function Jb() {
        var a = g.performance && g.performance.getEntriesByType,
            b = a ? f.filter(Ib, g.performance.getEntriesByType("paint")) : [];
    ...
    try {
        var va = function (a) {
            ...
            b.B = function (a, c) {
                b.C(a) || Object.defineProperty(a, "a", {configurable: !1, enumerable: !0, get: c})
            };
            b.X = function (a) {
            ...
            var c = this && this.V || function () {
                var a = Object.setPrototypeOf || {__proto__: []} instanceof Array &&
                    function (a, b) {
                        a.__proto__ = b
                    } || function (a, b) {
            ...
            var d = function (a) {
                ...
                b.prototype.o = function () {
                    ...
                    a.shaderSource(f, "precision mediump float;varying vec2 varyinTexCoordinate;void main() {gl_FragColor\x3dvec4(varyinTexCoordinate,0,1);}");
                    a.compileShader(f);
                    a.attachShader(d, e);
                    a.attachShader(d, f);
                    a.linkProgram(d);
                    a.useProgram(d);
                    d.R = a.getAttribLocation(d,
                        "attrVertex");
                    ...
                    b.push("webgl alpha bits:" +
                        a.getParameter(a.ALPHA_BITS));
                    ...
                    try {
                        ...
                        r && (b.push("webgl unmasked vendor:" + a.getParameter(r.UNMASKED_VENDOR_WEBGL)), b.push("webgl unmasked renderer:" + a.getParameter(r.UNMASKED_RENDERER_WEBGL)))
                    } catch (Ca) {
                    }
                    ...
                    b.push("webgl vertex shader high float precision rangeMin:" + a.getShaderPrecisionFormat(a.VERTEX_SHADER,
                        a.HIGH_FLOAT).rangeMin);
                    ...
                    b.push("webgl vertex shader medium float precision rangeMax:" + a.getShaderPrecisionFormat(a.VERTEX_SHADER,
                        a.MEDIUM_FLOAT).rangeMax);
                    ...
                    b.push("webgl vertex shader medium int precision rangeMin:" +
                    ...
                    b.push("webgl vertex shader low int precision rangeMax:" + a.getShaderPrecisionFormat(a.VERTEX_SHADER,
                        a.LOW_INT).rangeMax);
            ...
            b.hash = function (a, b) {
                a = a || "";
                b = b || 0;
                var r = a.length % 16, m = a.length - r, q = [0, b];
                b = [0, b];
                for (var h, k, O = [2277735313, 289559509], p = [1291169091, 658871167], n = 0; n < m; n += 16) h = [a.charCodeAt(n + 4) & 255 | (a.charCodeAt(n + 5) & 255) << 8 | (a.charCodeAt(n + 6) & 255) << 16 | (a.charCodeAt(n + 7) & 255) << 24, a.charCodeAt(n) & 255 | (a.charCodeAt(n + 1) & 255) << 8 | (a.charCodeAt(n + 2) & 255) <<
                16 | (a.charCodeAt(n + 3) & 255) << 24], k = [a.charCodeAt(n + 12) & 255 | (a.charCodeAt(n + 13) & 255) << 8 | (a.charCodeAt(n + 14) & 255) << 16 | (a.charCodeAt(n + 15) & 255) << 24, a.charCodeAt(n + 8) & 255 | (a.charCodeAt(n + 9) & 255) << 8 | (a.charCodeAt(n + 10) & 255) << 16 | (a.charCodeAt(n + 11) & 255) << 24], h = c(h, O), h = e(h, 31), h = c(h, p), q = l(q, h), q = e(q, 27), q = d(q, b), q = d(c(q, [0, 5]), [0, 1390208809]), k = c(k, p), k = e(k, 33), k = c(k, O), b = l(b, k), b = e(b, 31), b = d(b, q), b = d(c(b, [0, 5]), [0, 944331445]);
                h = [0, 0];
                k = [0, 0];
                switch (r) {
                    case 15:
                        k = l(k, f([0, a.charCodeAt(n + 14)], 48));
                    case 14:
                        k =
                            l(k, f([0, a.charCodeAt(n + 13)], 40));
                    case 13:
                        k = l(k, f([0, a.charCodeAt(n + 12)], 32));
                    case 12:
                        k = l(k, f([0, a.charCodeAt(n + 11)], 24));
                    case 11:
                        k = l(k, f([0, a.charCodeAt(n + 10)], 16));
                    case 10:
                        k = l(k, f([0, a.charCodeAt(n + 9)], 8));
                    case 9:
                        k = l(k, [0, a.charCodeAt(n + 8)]), k = c(k, p), k = e(k, 33), k = c(k, O), b = l(b, k);
                    case 8:
                        h = l(h, f([0, a.charCodeAt(n + 7)], 56));
                    case 7:
                        h = l(h, f([0, a.charCodeAt(n + 6)], 48));
                    case 6:
                        h = l(h, f([0, a.charCodeAt(n + 5)], 40));
                    case 5:
                        h = l(h, f([0, a.charCodeAt(n + 4)], 32));
                    case 4:
                        h = l(h, f([0, a.charCodeAt(n + 3)], 24));
                    case 3:
                        h = l(h,
                            f([0, a.charCodeAt(n + 2)], 16));
                    case 2:
                        h = l(h, f([0, a.charCodeAt(n + 1)], 8));
                    case 1:
                        h = l(h, [0, a.charCodeAt(n)]), h = c(h, O), h = e(h, 31), h = c(h, p), q = l(q, h)
                }
                q = l(q, [0, a.length]);
                b = l(b, [0, a.length]);
                q = d(q, b);
                ...
                q = d(q, b);
                b = d(b, q);
                return ("00000000" + (q[0] >>> 0).toString(16)).slice(-8) + ("00000000" + (q[1] >>> 0).toString(16)).slice(-8) + ("00000000" + (b[0] >>> 0).toString(16)).slice(-8) + ("00000000" + (b[1] >>> 0).toString(16)).slice(-8)
            }
        }, function (a, b, c) {
            b.a = !0;
            var d = c(6);
            ...
            b.a = !0;
            var e = c(1), f = c(4), l = c(0), g = c(2), h = c(3);
            a = function () {
                function a(a) {
                    var b =
                        this;
                    this.l = a;
                    this.G = {webGL: e.A, dnt: g.v, plugins: f.w, applePay: l.u};
    ...
    E.host = E.baseUrl + "ru";
    E.cross = "L21ldHJpa2EvenpsYy5odG1s";
    E.maxBodyLength = 7E5;
    var f = {
            mixin: function (a) {
                var b, c;
    ...
    var k = B.inherit({
        _initComponent: function () {
            ...
            e = k._getOpts(e);
            b = b.split(",");
            var f = b.length, l = this._listeners, m;
            for (m = 0; m < f; m++) {
                var h = b[m];
                var q = u(function (a) {
                    c.call(d || this, a || g.event)
                }, "on" + (h || "") + (e.name || ""));
                l[l.length] = [a, h, c, d, e, q];
                a.addEventListener ? a.addEventListener(h, q, k._prepOpts(e)) : a.attachEvent && a.attachEvent("on" + h, q)
            }
        },
        un: function (a, b, c, d, e) {
            e = k._getOpts(e);
            var r = this._listeners, l = r.length, g;
            for (g = 0; g < l; g++) {
                var h = r[g];
                if (h[0] == a && h[1] == b && h[2] == c && h[3] == d && f.isEqual(h[4], e)) {
                    r.splice(g, 1);
                    this._removeListener(a, b, h[5], e);
                    break
                }
            }
        }, unAll: function () {
    ...
    k.supportsPassive =
        function () {
            if (k._supportsPassive !== C) return k._supportsPassive;
    ...
    var x = {
        ...
        getMs: function () {
            return 0 < this.UNLOAD_MS ? this.UNLOAD_MS : this.isPerfomance ? Math.round(g.performance.timing.navigationStart + g.performance.now()) : +new Date
        },
        getFormStart: function () {
            return this.isPerfomance ? Math.round(g.performance.now()) : +new Date - this.initTime
        }
    };
    ...
    f.isArray = function (a) {
        return "function" === f.isFunction(Array.isArray) ? Array.isArray(a) : "[object Array]" === f.toString(a)
    };
    ...
    f.throttle = function (a, b, c, d) {
        ...
        return function () {
            ...
            e || function () {
                e = null;
                r && (a.apply(c || g, r), r = null, e = f.setTimeout(arguments.callee, b, d))
            }()
        }
    };
    var La = B.inherit({
        ...
        append: function (a, b) {
            ...
            this.active &&
            ((b || this.getFlushSize() >= this.maxBufferSize || this.getFlushSize() === this.maxChunkSize) && this._flush(b), this._flushTID || (this._flushTID = f.defer(this._flush, this.flushTimeout, this, [b], "DataBuffer._flush")))
        },
        activate: function () {
    ...
    f.async = function (a, b, c) {
        if (g.postMessage) {
            ...
            var e = function (c) {
                ...
                f === d && (c.stopPropagation && c.stopPropagation(), a.call(b), k.un(g, "message", e, null, {passive: !1}))
            };
    ...
    var za = B.inherit({
        transports: [], globalConfig: v, postParams: [], isDisabled: function () {
            return this.globalConfig.get("oo")
        }, send: function (a, b, c, d) {
            var e = [a], g = this, l = c || function () {
            };
            g.isDisabled() ? l.call(d) : function q(a) {
                if (a < this.transports.length) try {
                    ...
                    (function Ca(r) {
                        r >= e.length ? c.blockNext() ||
                            q.call(this, a + 1) : c.request(e[r], b, function (a, b, c) {
                            a ? l.call(d, b, c) : f.async(function () {
                                Ca.call(g, r + 1)
                            }, this, "senderCall")
                        }, this)
                    }).call(this, 0)
                } catch (zb) {
                    Ba(zb, "send by " + (c && c.id)), q.call(this, a + 1)
                }
            }.call(this, 0)
        }
    }), ka = {};
    ...
    ka.stringify = function (a, b) {
        var c = [], d = b || {}, e = {}, g = f.keys(a).length, l, m;
        if (d.lastOrdering !== C) for (m = 1; m <= b.lastOrdering.length; m++) e[b.lastOrdering[m -
        1]] = g + m;
        if (d.firstOrdering !== C) for (m = 0; m < b.firstOrdering.length; m++) e[b.firstOrdering[m]] = m;
        for (l in a) if (a.hasOwnProperty(l)) if (d = a[l], f.isArray(d)) for (m = 0; m < d.length; m++) c.push({
            key: l,
            value: encodeURIComponent(l) + "\x3d" + encodeURIComponent(String(d[m]))
        }); else c.push({key: l, value: encodeURIComponent(l) + "\x3d" + encodeURIComponent(String(d))});
        c.sort(function (a, b) {
    ...
    var S = B.inherit({
        postParams: [], index: 0, blockNext: function () {
            ...
            var b = {}, c = {};
            f.forEachKey(a, function (a, e) {
                f.inArray(this.postParams, a) ? c[a] = e : b[a] =
                    e
            }, this);
            return {get: b, post: c}
        ...
        id: "XHR", index: 7, method: "POST", withCredentials: !0, request: function (a, b, c, d) {
            var e = this, f;
            if (/[^a-z0-9.:-]/.test(J.host) && g.opera && "function" === typeof g.opera.version) {
                var l = g.opera.version();
                if ("string" === typeof l && "12" === l.split(".")[0]) return c.call(d, !1)
            }
            if (g.XMLHttpRequest) {
                ...
                if ("withCredentials" in m) {
                    ...
                    m.onreadystatechange = function () {
                        if (4 === m.readyState) {
                            try {
                                f = e._parseResp(m.responseText)
                            } catch (O) {
                                return c.call(d, !1)
                            }
                            c.apply(d, [200 === m.status].concat(f))
                        }
                    };
                    return
                }
    ...
    var Kb = S.inherit({
        id: "beacon", index: 1, request: function (a, b, c, d) {
            "function" === typeof navigator.sendBeacon && !n.isAndroidWebView() && navigator.onLine ? (b = this._splitParams(b), b.get["force-urlencoded"] = 1, c.call(d, navigator.sendBeacon(this._buildUrl(a,
                b.get), ka.stringify(b.post)))) : c.call(d, !1)
        }
    });
    ...
    var la = S.inherit({
            ...
            _initComponent: function () {
                la.superclass._initComponent.apply(this, arguments);
                "_htmlfile" in la.prototype || (la.prototype._htmlfile = this._createHtmlfile());
            ...
            request: function (a, b,
                ...
                l.style.top = "-99999px";
                var m = ['\x3ciframe name\x3d"', g, '"\x3e\x3c/iframe\x3e', '\x3cform action\x3d"', this._buildUrl(a, b.get), '" method\x3d"post" target\x3d"', g, '" enctype\x3d"', this.enctype, '"\x3e'];
                f.forEachKey(b.post, function (a) {
                    f.mergeArrays(m, ['\x3cinput type\x3d"hidden" autocomplete\x3d"off" autocorrect\x3d"off"', ' autocapitalize\x3d"off" spellcheck\x3d"false" name\x3d"',
                        a, '"/\x3e'])
                });
                f.mergeArrays(m, ["\x3c/form\x3e"]);
                l.innerHTML = m.join("");
                e.body.appendChild(l);
                var h = l.getElementsByTagName("form")[0];
        ...
        Lb = la.inherit({id: "htmlfile", index: 3, htmlfileOnly: !0}), Q = S.inherit({
    ...
    f.toJSON = function (a) {
        ...
        switch (a.constructor) {
            ...
            case Object:
                c = [];
                for (d in a) a.hasOwnProperty(d) && a[d] !== C && (c[c.length] = f.toJSON(d) + ":" + f.toJSON(a[d]));
                return "{" + c.join(",") + "}";
            default:
                return da.stringify(a)
        }
    };
    var T = B.inherit({
    ...
    var P = {abc: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789", tail: "+/\x3d", tailSafe: "*-_"},
        F = B.inherit({
    ...
    var ma = {
        _storage: new T, _cookie: new F,
        key: "zzlc", updateInfo: function (a) {
            f.forEachKey(this.getInfoFlags(), function (b, c) {
                var d = c.call(this);
                d && (a[b] = d)
            }, this);
            return a
            ...
            return {zz: this.getZZ, pp: this.getPP, pu: this.getPU}
        },
        checkVersion: function () {
            var a = n.getMacOSVersion();
            return !((n.isIOS() || 10 <= a[0] && 13 <= a[2]) && n.isSafari()) || n.isSafariWebView()
        }, noop: function () {
        }, genPu: function (a) {
            var b = f.fnv32a(g.location.host) + this._cookie.read("uid");
            this.pu = b;
            a.set("pu", b);
            return b
        }, initPU: function (a, b) {
            ...
            }, this), g.opener ? (f.setTimeout(function () {
                c.genPu(b)
            }, 200, "pu"),
                a.sendToIframe(g.opener, {type: "gpu-get"}, this.handleGpu, this)) : this.genPu(b))
            ...
            c && 0 < c.length && (this.pp = f.fnv32a(c[1]), this.globalConfig.set("pp", this.pp));
            a.onicecandidate = this.noop;
            a.close()
        }, "wrt"), onOffer: function (a, b) {
            f.isFunction(a.setLocalDescription) && a.setLocalDescription(b,
                this.noop, this.noop)
        }, initPP: u(function (a) {
            ...
            if (g.navigator.onLine && b && a.get("pp") == C && (this.globalConfig.setSafe("pp", null), b && b.prototype && b.prototype.constructor && b.prototype.constructor.name)) {
                ...
                if (f.isFunction(c.createOffer) && !c.createOffer.length) {
                    try {
                        var d = c.createOffer()
                    } catch (e) {
                        return
                    }
                    f.isFunction(d.then) && d.then(f.bind(this.onOffer,
                        this, c));
                    c.onicecandidate = f.bind(this.onicecandidate, this, c)
                }
            }
        }, "rcinit"), initZZ: function () {
            var a = this;
            if (!this.getZZ() && !this.checkVersion()) {
                var b = f.getNativeFunction("createElement", h)("iframe");
                b.style.display = "none";
                b.style.width = "1px";
                b.style.height = "1px";
                b.style.visibility = "hidden";
                b.src = E.protocol + "//" + E.host + P.decode(E.cross);
                g.document.documentElement.appendChild(b);
                k.on(g, "message", this.onMessage, this, {passive: !1});
                this.frame = b;
                this.timeout = f.setTimeout(function () {
                    k.un(g, "message", a.onMessage,
                        a, {passive: !1});
            ...
            a.data && a.data.substr && "__ym__zz" === a.data.substr(0, 8) && (this.zz = a.data.substr(8), p.removeNode(this.frame), this._storage.set(this.key, this.zz), k.un(g, "message", this.onMessage, this, {passive: !1}), clearTimeout(this.timeout))
        }
    }, A = za.inherit({
        protocol: "",
        host: E.host,
        ...
        send: function (a, b, c, d) {
            var e = this.globalConfig.get(ea.globalKey), f = this;
            e && 3 !== this.counterId ? e(function () {
                var e = f._registerRequest(a, b);
                f._sendSavedRequest(e, a, b, c, d)
            }, a) : (e = f._registerRequest(a, b), f._sendSavedRequest(e, a, b, c, d))
        },
        _sendSavedRequest: function (a, b, c, d, e) {
            var g = this.globalConfig.get("firstReqStatus"), l = b.forceNoRedirect;
            if ("process" == g) this.globalConfig.set("firstReqCallbacks",
                f.mergeArrays(this.globalConfig.get("firstReqCallbacks") || [], [[this, arguments]])); else {
                ...
                c.fip || delete c.fip;
                c = ma.updateInfo(c);
                g = [this.protocol, "//", this.host, "/", this.resource, "/", this.counterId, l ? "/1" : ""].join("");
                delete b.forceNoRedirect;
                var m = [];
                c && (f.forEachKey(c, function (a,
                                                b) {
                    "t" != a && f.mergeArrays(m, [a, b])
                }), c.t && f.mergeArrays(m, ["t", c.t]));
                m.length && (b["browser-info"] = m.join(":"));
                return A.superclass.send.call(this, g, b, function () {
                    var b;
    ...
    A._storage = new T;
    A._fipKey = "fip";
    A.fpFactors = ["webGL", "plugins", "applePay", "dnt"];
    A.initFingerPrint = function () {
        var a = [];
        if (n.isSafari() && (navigator.userAgent.match(/Mac OS X[^_.]10[_.](13|12)/) || navigator.userAgent.match(/iPhone; CPU iPhone OS (11|10|12)/))) {
            var b = A._storage;
            b.get(this._fipKey) ? a = b.get(this._fipKey) : (a = new va(f.reduce(function (a, b) {
                    a[b] = 1;
                    return a
                },
                {}, A.fpFactors)), a = a.toString(!1).join("-"), b.set(this._fipKey, a));
            this._fingerPrint = a
        }
    };
    A.getFP = function () {
        return this._storage.get(this._fipKey) ? this._storage.get(this._fipKey) : A._fingerPrint
    };
    A.initCookie = function () {
        var a = new F, b = a.read("uid"), c = a.read("d"), d = x.getSeconds();
        if (!b) b = d + "" + f.random(), a.create("uid", b, 525600), a.create("d", d, 525600); else if (!c || 15768E3 < d - parseInt(c)) a.create("uid", b, 525600), a.create("d", d, 525600);
        A._userID = b
    };
    A.retransmit = function (a) {
        var b = A._storage, c = b.get("retryReqs") ||
            {}, d;
        b.remove("retryReqs");
        f.forEachKey(c, function (b, c) {
            var e = x.getMs();
            a.get("firstReqStatus") || a.set("firstReqStatus", "complete");
            c.ghid && c.ghid != a.get("_globalMetrikaHitId") && c.time && c.time + 864E5 > e && 500 < e - c.time && 2 >= c.browserInfo.rqnl && (d = new A({
                protocol: c.protocol,
                host: c.host,
                resource: c.resource,
    ...
    f.fletcher = function (a) {
        for (var b = a.length, c = 0, d = 255, e = 255, f, g, m; b;) {
            f = 21 < b ? 21 :
                b;
            b -= f;
            do g = "string" == typeof a ? a.charCodeAt(c) : a[c], c++, 255 < g && (m = g >> 8, g &= 255, g ^= m), d += g, e += d; while (--f);
            d = (d & 255) + (d >> 8);
            e = (e & 255) + (e >> 8)
        }
    ...
    P.encode = function (a, b) {
        var c = (P.abc + (b ? P.tailSafe : P.tail)).split(""), d = a.length, e = [], g = d - d % 3, l;
        for (l = 0; l < g; l += 3) {
            var m = (a[l] << 16) + (a[l + 1] << 8) + a[l + 2];
            f.mergeArrays(e, [c[m >> 18 & 63], c[m >> 12 & 63], c[m >> 6 & 63], c[m & 63]])
        }
        switch (d - g) {
            case 1:
                m = a[g] << 4;
                f.mergeArrays(e, [c[m >> 6 & 63], c[m & 63], c[64], c[64]]);
                break;
            case 2:
                m = (a[g] <<
                    10) + (a[g + 1] << 2), f.mergeArrays(e, [c[m >> 12 & 63], c[m >> 6 & 63], c[m & 63], c[64]])
        }
        return e.join("")
    };
    ...
    f.isNumber = function (a) {
        return isFinite(a) && !isNaN(a) &&
            "[object Number]" === f.toString(a)
    };
    f.isString = function (a) {
        return "[object String]" === f.toString(a)
    };
    ...
    f.isObject = function (a) {
        try {
            return a && null !== a && "[object Object]" === f.toString(a)
        } catch (b) {
            return !1
        }
    };
    ...
    p.getRootElement = function () {
        var a = h.documentElement, b = p.getBody();
    ...
    p.getDocumentTitle = function () {
        var a = h.title;
        "string" != typeof a && (a = (a = h.getElementsByTagName("title")) &&
    ...
    n.getSilverlightVersion = function () {
        if (!n._silverlightVersion) if (g.ActiveXObject) try {
            ...
            b = b.plugins && b.plugins["Silverlight Plug-In"]) n._silverlightVersion = b.description;
    ...
    n.getFlashVersion = function () {
        if (!n._flashVersion) {
            ...
            if ("undefined" != typeof a.plugins && "object" == typeof a.plugins["Shockwave Flash"]) {
                ...
                var c = b.version;
                if ((b = b.description) || c) if (a = a.mimeTypes, "undefined" == typeof a || !a["application/x-shockwave-flash"] || a["application/x-shockwave-flash"].enabledPlugin) c ? n._flashVersion =
                    c : b && (n._flashVersion = b.replace(/([a-zA-Z]|\s)+/, "").replace(/(\s+r|\s+b[0-9]+)/, "."))
    ...
    k.ready = function (a) {
        ...
        if ("interactive" === b || "complete" === b) f.setTimeout(a, 0, "evt::ready"); else {
            ...
            k.on(h, "DOMContentLoaded",
                c);
            k.on(g, "load", c)
        }
    };
    var sb = {
        url: E.protocol + "//" + E.host + "/metrika/", _value: null, init: function (a) {
            ...
            k.ready(function () {
                ...
                n.isSafari() && (b.style.position = "absolute", b.style.visibility = "hidden", b.style.width = "0px", b.style.height = "0px", p.getRootElement().appendChild(b))
            })
        }, _saveReq: function (a) {
            this._value = a = a ? "1" : "2";
        ...
        encode: function (a) {
            ...
            for (var b = "", c = 0, d, e, f; c < a.length;) d = a.charCodeAt(c), 128 > d ? (b += String.fromCharCode(d), c++) : 191 < d && 224 > d ? (e = a.charCodeAt(c + 1), b += String.fromCharCode((d & 31) << 6 | e & 63), c += 2) : (e = a.charCodeAt(c + 1), f = a.charCodeAt(c + 2), b += String.fromCharCode((d &
                15) << 12 | (e & 63) << 6 | f & 63), c += 3);
            return b
        }
    };
    P.decode = function (a, b) {
        for (var c = P.abc + (b ? P.tailSafe : P.tail), d = 0, e = "", f, g, m, h, k; a.length % 4;) a += "\x3d";
        do {
            ...
            g = m >> 8 & 255;
            m &= 255;
            e = 64 == h ? e + String.fromCharCode(f) : 64 == k ? e + String.fromCharCode(f, g) : e + String.fromCharCode(f, g, m)
        } while (d < a.length);
        return e
    };
    ...
    var wa = A.inherit({
        ...
        sendTitle: !0,
        _initComponent: function () {
            wa.superclass._initComponent.apply(this,
                arguments);
        ...
        sendHit: function (a) {
            this._hitExt({
                ...
                referrer: a.referrer,
                vParams: a.vParams,
                modes: f.mixin(a.modes || {}, {ar: !0, saveRef: !0, pv: !0}),
                callback: a.callback,
                ctx: a.ctx
            }, "hit")
        },
        ...
        sendPrerenderHit: function (a) {
            this._hitExt({url: a.url, title: a.title, referrer: a.referrer, modes: {ar: !0, pq: !0}}, "hit")
        },
        ...
        sendClickLink: function (a) {
            this._hitExt({url: a.url, title: a.title, referrer: y().href, modes: a.modes})
        },
        ...
        _hitExt: function (a, b) {
            ...
            if (!f.isMetrikaPlayer()) {
                var m = a.modes || {};
                var h = a.browserInfo || {};
                var k = "undefined" !== typeof a.referrer ? a.referrer : Va.lastReferrer;
                var t = a.url || "";
                var n = {};
                a.nohit && c("nohit", 1);
                m.ar && !m.onlyData && (k = null === k || "" === k ? "" : this._prepareHitUrl(k), t = this._prepareHitUrl(a.url));
                c("forceNoRedirect", a.forceNoRedirect);
                c("page-ref", f.trim(k, Aa));
                c("page-url", f.trim(t, Aa));
                f.is4Bytes(a.title) && c("charset", "utf-8");
                -1 != y().hostname.search(/(?:^|\.)(?:ya|yandex)\.(?:\w+|com?\.\w+)$/) ? c("ut", ib) : "undefined" !=
                    typeof m.ut && c("ut", f.trim(m.ut, Mb));
                c("exp", a.experiments);
                (e = a.vParams) && this.counter && e.__ym && (f.isNumber(e.__ym.turbo_page) && (this.counter.tp = e.__ym.turbo_page), f.isNumber(e.__ym.turbo_page_id) && (this.counter.tpid = e.__ym.turbo_page_id));
                (!e || f.isObject(e) && !e.__ym && !e.__ymu) && this.paramsQueue.length() && f.inArray(["go", "hit", "pa"], b) && (e = this.paramsQueue.mixin(e));
                e && (t = f.toJSON(e), this.trimParams && t.length > Nb ? g = !0 : t > E.maxBodyLength ? f.warning("Too big params") : c("site-info", t));
                m.saveRef && (Va.lastReferrer =
                    k);
                l = function (a, b) {
                    var c = {};
                    f.forEachKey(b, function (a, b) {
                        -1 === f.arrayIndexOf(["", C, null], b) && (c[a] = b)
                    });
                    return f.mixin({}, a, c)
                }(l, {
                    gdpr: ea.getState(this.globalConfig),
        ...
        getFu: function (a, b) {
            var c = a !== y().href, d = h.referrer.replace(/\/$/, ""), e = (b || "").replace(/\/$/, "");
            d = d !== e;
            e = 0;
            d && c ? e = 3 : d ? e = 1 : c && (e = 2);
            return e
        },
        _getTechInfo: function (a, b, c, d, e, h, l, m, k, q) {
            function r(a, b, c) {
                var d = "" + b;
            ...
            d = d || x.getTimestamp();
            e = e || x.getTimezone();
            r("j", n.getJavaEnabled() ? "1" : "");
            var u = n.isDesktop(this.globalConfig);
            u !== C && r("dp", u ? "1" : "0");
            r("nt", n.netType());
            r("ns", n.getNavigationStart());
            W && r("s", W.width + "x" + W.height + "x" + (W.colorDepth || W.pixelDepth));
            g.devicePixelRatio && r("sk", g.devicePixelRatio);
            n.isIframe() && (r("ifr", "1"), r("sti", n.isSameOriginTopFrame() ? "1" : "0"));
            g.ia_document && g.ia_document.shareURL && g.ia_document.referrer && r("iia", "1");
            r("adb", sb.getVal());
            r("f", n.getFlashVersion());
            r("l", n.getSilverlightVersion());
            r("fpr", n.getFingerPrint());
            r("cn", this.counterNum);
            b.pa || (u = p.getViewportSize(), r("w", u[0] + "x" + u[1]));
            r("z", e);
            r("i", d);
            r("et", x.getSeconds());
            r("en", p.getDocumentCharset());
            r("c", navigator.cookieEnabled ? "1" : "");
            r("la", n.getLanguage());
            r("ntf", n.getNotificationPermission());
            f.random(100) || r("np", P.encode(Ua.encode(f.trim(n.getPlatform(), 100))));
            h && r("wh", "1");
            e = "ar ln dl cpf ad nb pa pq pv ex".split(" ");
            for (d = 0; d < e.length; d++) O(e[d]);
            e = "va vt sn sa he fu".split(" ");
            b.nb && e.push("cl");
            for (d = 0; d < e.length; d++) h = e[d], r(h, b[h]);
            e = new T({counterId: c});
            e.isEnabled() && (c = e.getStorageId(), d = e.get("reqNum"), q || (d ? d++ : d = 1), e.set("reqNum", d), e.get("reqNum") == d ? (r("ls", c), r("rqn",
                d)) : (e.remove("reqNum"), e.clearStorageId(), 1 < d && (r("ls", c), r("rqn", 0))));
            r("rn", f.random());
            r("hid", l);
            q || 3 == this.counterId || r("ds", Hb(k));
            k._firstPaint || q || (k._firstPaint = Jb(), r("fp", k._firstPaint));
            if (m) {
                g.name || (g.name = Math.round(65535 * Math.random()));
                if (l = +g.name) 0 > l && (l *= -1), l %= 65535;
                r("wn", l || f.fletcher(g.name));
                try {
            ...
            l = "";
            this.sendTitle && (l = this._getTitle(a));
            r("t", l, !0);
            return v
        },
        _getTitle: function (a) {
            a = "undefined" == typeof a ? (a = p.getDocumentTitle()) ?
                f.trim(a, Wa) : "" : f.trim(a, Wa);
            return a
        }
    });
    ...
    var oa = B.inherit({
        sampling: 1, counterId: 26302566, _initComponent: function () {
            ...
            this._sender = new wa({protocol: "https:", counterId: this.counterId, retry: !1, counter: {}})
        }, log: function () {
        ...
        retry: !0,
        postParams: ["wv-data"],
        sendPacket: function (a, b, c, d, e, r, l, m) {
            if (!a || !a.length) return !1;
            var h = P.encode(a, !0);
            if (0 == h.indexOf("AAAAAAAAADw") && g.Error) {
                var k = Error();
                "string" == typeof k.stack && (new oa({sampling: .1})).log("bad visor packet 5", 1)
            }
            a = {
                rn: f.random(),
                "page-url": b,
            ...
            e = {v: this._getVersion(), z: e, i: r};
            return this.send(a, e, l, m)
        }
    }), Ta = La.inherit({
        protocol: "",
        counterId: "",
        ...
        resource: "webvisor", transports: [ra,
            la], postParams: ["wv-data"], sendContent: function (a, b, c, d, e, f, g) {
            if (!a) return !1;
            -1 < a.indexOf("\r") && (a = a.replace(/\r\n/g, "\n"));
            a = {"wv-type": 1, "page-url": y().href, "wv-hit": c, "wv-data": P.encode(Ua.encode(a))};
    ...
    p.getElementChildren = function (a, b) {
        ...
        if (a && (d = a.childNodes)) {
            ...
            for (g = d.length; l < g; l++) {
                var h = d[l];
                (e = "INPUT" == h.nodeName && h.type && "hidden" == h.type.toLocaleLowerCase()) || b && h.nodeName != b || f.mergeArrays(c, [h])
            }
        }
        return c
    };
    ...
    p.getElementsByClassName = function (a, b) {
        ...
        var e = [];
        for (c = 0; c < d.length; c++) p.classNameExists(d[c], a) && e.push(d[c]);
        return e
    };
    ...
    var Db = !ua(/webkit/) && ua(/gecko/), tb = B.inherit({
        hid: 0,
        tz: 0,
        ts: 0,
        counterId: 0,
        ...
        _initComponent: function () {
            if (this.isEnabled()) {
                ...
                this._vc = b;
                "b" !== b && (this._recorder = new yb(this.protocol, this.counterId, this.counterType, this.hid, this.globalConfig));
        ...
        start: function (a) {
            if (this.isEnabled() && this._recorder) {
                ...
                "w" === c ? (this._recorder.start(), b = a.arch_type, (a = a.urls) && b && "none" !== b && this._recorder.uploadPages(a,
                    b)) : this._recorder.stop()
            }
        },
        stop: function () {
    ...
    p.loadScript = function (a, b) {
        ...
        if (h) {
            ...
            c.async && (h.async = !0);
            try {
                var l = d.getElementsByTagName("head")[0];
                if (!l) {
    ...
    za = S.inherit({
        id: "script", index: 6, request: function (a, b, c, d) {
            var e = !1, r = f.getNativeFunction("createElement", h)("script");
            this.timeout && f.setTimeout(function () {
                e || (e = !0, p.removeNode(r), c.call(d, !1))
            }, this.timeout, "ts.request");
            if (!r) return e = !0, c.call(d, !1), !1;
            var l = "_ymjsp" + f.random();
            g[l] = u(function () {
                if (!e) {
                    try {
                        delete g[l]
            ...
            r.src = this._buildUrl(a, f.mixin({wmode: 5, callback: l}, b));
            r.async = "async";
            var m = h.getElementsByTagName("head")[0];
            m || (m = h.createElement("head"), h.documentElement.appendChild(m));
            f.async(function () {
    ...
    var Xa = ra.inherit({
        id: "XHRhit", index: 10, _buildUrl: function (a,
                                                      b) {
            b.wmode = 7;
            return Xa.superclass._buildUrl.apply(this, [a, b])
        }, _parseResp: function (a) {
            var b = da.parse(a);
            if (!b) throw"";
            return f.map(function (a) {
        ...
        transports: [Xa, za], trimParams: !0, _initComponent: function () {
            ...
            if (a) {
                a:{
                    if (a = f.parseUrl(a).host.match(/(?:^|\.)(?:ya|yandex)\.(?:\w+|com?\.\w+)$/)) if (a = a[0].split("yandex").reverse()[0].substring(1),
                    -1 != f.arrayIndexOf(E.yandexWhiteListTld, a)) break a;
                    a = !1
                }
                a && (this.host = E.baseUrl + a)
            }
        }, sendHit: function (a) {
            var b = {}, c = this._ilStorage.get("il");
            a.visitColor && (b.vc = a.visitColor);
            a.hasPrerender && (b.pr = 1);
            c && (this._ilStorage.remove("il"), b.ilt = P.encode(Ua.encode(f.trim(c, ub))));
        ...
        cid: 3, cnt: 0, KEY_NAME: "wasSynced", _initComponent: function () {
            ...
            var c = this, d = b === C ? !0 : !1, e = d ? this._storage.get(this.KEY_NAME) : !1, g = [],
                h = this.globalConfig.get("fakeHit");
            if (h) return h(function (b) {
                a(b)
            });
            !e && d && (e = this._cookie.read(this.KEY_NAME)) && (e = da.parse(e));
            e && e.params && e.time + 864E5 > x.getMs() ? (c.globalConfig.set("isEU", e.params.eu), a(e)) : (this.globalConfig.set("fakeHit",
                function (a) {
                    g.push(a)
                }), this._getSender().sendHit({
                forceNoRedirect: this.forceNoRedirect, callback: function (b, d) {
                    var h = b || {};
                    e = {time: x.getMs(), params: h, bkParams: d};
                    c.globalConfig.set("isEU", h.eu);
                    c._storage.set(c.KEY_NAME, e);
                    c._cookie.create(c.KEY_NAME, da.stringify(e), 1728);
                    a(e);
                    c.globalConfig.set("fakeHit", function (a) {
                        a(e)
                    });
                    f.arrayEvery(g, function (a) {
                        a(e);
                        return 1
                    })
                }
            ...
            this._sender || (this._sender = new jb({
                protocol: "https:", counterType: this.cnt, counterId: this.cid, sendTitle: !1,
                globalConfig: this.globalConfig, fake: !0
            }));
            return this._sender
        }
    }), vb = B.inherit({
        ...
        _initComponent: function () {
            ...
            this.syncTlds = f.reduce(function (a, c) {
                return c(a)
            }, E.yandexWhiteListTld, [f.bind(f.filter, null, function (b) {
                return b !== a.baseTld
            ...
            f.forEachKey(this.partners, function (a, c) {
        ...
        sync: function (a) {
            var b = this, c = this._need(),
                d = -1 != y().hostname.search(/(?:^|\.)(?:ya|yandex|beru|kinopoisk)\.(?:\w+|com?\.\w+)$/);
            !this._is() && c ? (this._setStatus(!0),
        ...
        _addMda: function () {
            var a = new F({skipPrefix: !0}), b = new F, c = a.read("mda");
        ...
        _need: function () {
            ...
            c = f.arrayFilter(c, function (a) {
                return (e[a] || 1) + 1440 < x.getMinutes()
            });
            return c.length && c || !1
        },
        _sync: function (a, b) {
            var c, d = 0, e = E.protocol + "//", f = a.length, g = this;
            if (0 < f) {
                b = b || function () {
                };
                var h = function () {
                ...
                for (c = 0; c < f; c++) (function (a) {
                    q.request(e + (g._replaceBase[a] ? a : g.baseUrl + a) + "/sync_cookie_image_check", {}, function (b) {
                        h();
                        var c = x.getMinutes();
                        b || (c -= 1435);
                        b = k.get("synced") || {};
        ...
        _getCn: function () {
            this._cn || (this._cn = new Za({fake: !0, globalConfig: this.globalConfig}));
            return this._cn
        },
        _getLs: function () {
        ...
        _getDomainByLang: function () {
            ...
            try {
                var a = navigator.languages ? navigator.languages[0] :
                    n.getLanguage()
            } catch (b) {
            }
    ...
    var na = {
        ...
        init: function (a) {
            ...
            this._getReq().request(this._url + ka.stringify({key: a, value: f.toJSON(b)}));
            this._getLs().set(a, b)
        }, get: function (a) {
        ...
        sync: u(function (a, b, c, d) {
            ...
            if (this._enabled(a, b, c)) {
                this._setStatus(!0);
                var f = new Pb({method: "GET", withCredentials: !1});
                var g = this._getHosts();
                var h = g.length;
                (function t(a) {
                    var b = g[a];
                    a < h ? f.request(b[0] + ":" + b[1] + "/p", e, function (c, d) {
                        c ? this._save(c, d, b[1]) : t.call(this, a + 1)
                    }, this) : this._save(!1)
                }).call(this, 0)
            }
        }, "ds"), _getHosts: function () {
            var a = [], b = J.protocol, c = n.isIOS();
            (n.isAndroid() || c && "http:" === b) && a.push(["http://127.0.0.1", "30102"], ["http://127.0.0.1", "29009"]);
            c && "https:" === b && a.push(["https://yandexmetrica.com",
                "30103"], ["https://yandexmetrica.com", "29010"]);
            return a
            ...
            if (!(60 < x.getMinutes() - na.getNum("ds")) || this._is() || f.isDev(this.globalConfig)) return !1;
            a = 0 === b && 0 <= f.arrayIndexOf([39370095, 1282253, 29302335, 43653484,
                41734944, 31048081, 16443139, 27737346, 41870499, 33911514, 30744873, 5564395, 2580487], a);
            a = ja() || !c && .1 >= Math.random() && a;
            c = n.isIOS() && a;
        ...
        getPos: function (a) {
            ...
            var b = null;
            try {
                if (b = a.target || a.srcElement) !b.ownerDocument && b.documentElement ?
                    b = b.documentElement : b.ownerDocument !== h && (b = null)
            } catch (c) {
            }
            return b
    ...
    G.dispatchCustomEvent = u(function (a, b) {
        var c;
        b = b || h;
        if (c = f.getNativeFunction("createEvent", h)("Event")) c.initEvent(a, !1, !1), f.getNativeFunction("dispatchEvent", b)(c)
    }, "evt.dispatch");
    var Va = {lastReferrer: null}, fa = B.inherit({
        counter: null, prefsEcommerce: null,
        status: {NEW: C, PENDING: 1, OK: 2, FAIL: 3}, dataLayerName: "dataLayer", _initComponent: function () {
            ...
            if (this.prefsEcommerce || this.prefsUseDataLayer) this._overridePush(this.prefsEcommerce) || (f.isString(this.prefsEcommerce) && (this.dataLayerName = this.prefsEcommerce), a = this.dataLayerName, this._tryTimeout = f.bind(this._tryTimeout, this), this._tryTimeout()), this.counter._ecommerce = a
            ...
            f.arrayEvery(fa.handlers, function (b) {
                b && b.type && f.arrayEvery(b.type.split(","), function (c) {
        ...
        _convert: function (a, b) {
            var c = f.keys(b), d = !1, e = {transaction_id: "id", value: "revenue"};
            if (b.items) {
                var g = {};
                g[a] = {products: b.items};
                1 < c.length && (g[a].actionField = f.reduce(function (a, c) {
                    e[c] ? a[e[c]] = b[c] : "currency" === c ? d = b[c] : "items" !== c && b[c] && (a[c] = b[c]);
                    return a
                }, {}, c));
                d && (g.currencyCode = d);
                return g
            ...
            a && "event" === a[0] && b[a[1]] && (a = this._convert(b[a[1]],
                a[2])) && c.push(a);
            return c
        }, _send: function (a) {
            ...
            for (e = a.length; h < e; h++) {
                if ((d = a[h]) && d.ymetrikaEvent) {
                    ...
                    "params" === l.type && l.data && (l.sended || (l.sended = []), l.counter ? this.counter && this.counter.params && this.counterId == l.counter && (this.onCookies(function (a) {
                        this.counter.params(a.data)
                    }, this, f.mixin({}, l)), l.sended.push(this.counterId)) : f.forEachKey(this.globalConfig.get("counters"), function (a, b) {
                        var c = a.split(":")[0];
                        !f.inArray(l.sended, c) && b && b.params && (this.onCookies(function (a, b) {
                            a.params(b.data)
                        }, this, b, f.mixin({}, l)), l.sended.push(c))
                ...
                if (d && d.ecommerce) {
                    ...
                    f.forEachKey(d.ecommerce, function (a, b) {
                        0 <= f.arrayIndexOf(c, a) && (k = !0, m[a] = b)
                    });
                    k &&
                    b.push(m)
                }
    ...
    var Rb = {
            ...
            asyncBuffer: [],
            timeout: null,
            addAsyncItem: function (a, b, c, d, e) {
                var g = this;
                this.asyncBuffer.push({fn: a, ctx: b, args: d || [], loggerName: e || ""});
                c ? g.flushAsync(!0) : (clearTimeout(this.timeout), this.timeout = f.setTimeout(function () {
                    g.flushAsync();
                    g.timeout = null
                }, this.restTime))
            },
            chain: function (a, b, c, d) {
                ...
                (function q(b, c, f) {
                    e.addAsyncItem(function (b, c, d) {
                        c = a[b++](c);
                        b <= a.length - 1 && q(b, c, d)
                    }, null, f, [b, c], d + "." + b)
                })(0, b, c)
            },
            callByTimeout: function (a, b) {
                var c = +new Date, d = 0, e = (b || 0) + 1, g = this;
                f.arrayEvery(this.asyncBuffer, function (b, h) {
                    ...
                    return a || 0 == this.asyncBuffer.length ? !0 :
                        h >= this.asyncChunk || d >= this.maxDuration ? (f.setTimeout(function () {
                            g.callByTimeout(a, e)
                        }, this.restTime), !1) : !0
                }, this)
            },
        ...
        $a = "GDPR-ok GDPR-cross GDPR-cancel GDPR-skip GDPR-frame-skip GDPR-frame-ya GDPR-frame-noya GDPR-open-start GDPR-eu-skip GDPR-open-fail GDPR-open-success GDPR-cookie-success GDPR-cookie-fail GDPR-skip-login GDPR-skip-domain GDPR-skip-na GDPR-skip-eu-na GDPR-skip-wv".split(" "),
        Sb = ["https://brozen.yandex.ru", "https://yabro1.zen-test.yandex.ru/yabro/index.html",
            ...
            globalKey: "f1", MAX_SIZE: 1E6, isYAN: !1, trigger: function (a) {
            ...
            }, enabled: ja() && -1 < g.location.href.indexOf("yagdprcheck\x3d1"), _initComponent: function () {
                this._cookie = ea.cookie;
                this._sender = new Za({fake: !0, globalConfig: this.globalConfig, forceNoRedirect: !0})
            }, realise: function (a, b) {
                this.initCounter.apply(g, a);
                this.globalConfig.set(this.globalKey, function (a) {
                    a()
                });
                b.length && Rb.chain(b.concat([function () {
                    b = []
                }]), null, !1, "GDPR")
            }, showPopup: function (a, b, c, d, e) {
                var f = this;
                a = p.loadScript({src: "https://yastatic.net/q/global-notifications/cc/_lego-cc" + a + "." + b + ".js"});
                ...
                a.onerror = function (a) {
                    ...
                    f.realise(c, d);
                    f.frameConnector.sendToChildren({type: "GDPR-ok"})
                };
                a.onload = function () {
                    f.trigger("GDPR-open-success");
                    fa.handlers = fa.handlers.concat([{
                        type: "GDPR-ok, GDPR-cross", callback: function (a) {
                            a.once ||
                            (e.create("gdpr", "0", 525600), f.realise(c, d), f.frameConnector.sendToChildren({type: "GDPR-ok"}), a.once = !0)
                        }
                    }, {
                        type: "GDPR-cancel", callback: function () {
                            e.create("gdpr", "1");
                            f.logCancel();
                            f.frameConnector.sendToChildren({type: "GDPR-cancel"})
                        }
                    }])
                }
            }, askGDPR: function (a, b, c, d, e, g) {
                if (f.inArray([null, ""], a)) this.showPopup(b, c, d, e, g); else if ("0" === a) this.trigger("GDPR-cookie-success"), this.realise(d, e); else if ("1" === a) return this.trigger("GDPR-cookie-fail"), this.logCancel(), !1
            }, logCancel: function () {
                this._sender.hit(function () {
                    },
                    !1)
            }, handle: function () {
                var a = this._sender, b = [], c = (n.getLanguage() || "").toLowerCase().split("-")[0],
                    d = "ontouchstart" in g ? "-touch" : "", e = this._cookie, h = e.read("gdpr"),
                    l = e.read("yaGdprCheck"), k = this, p = this.globalConfig.get(this.globalKey), q = arguments;
                b.size = 0;
                if (p) return p(function () {
                    k.realise(q, b)
                });
                f.inArray("ru en kk be ky tr tt uk".split(" "), c) || (c = "en");
                if (!this.enabled && ("0" === h || n.isSafariWebView() || n.isAndroidWebView() || f.inArray(Sb, g.location.href.split("?")[0]) || !ja() || e.read("yandex_login") ||
                    this.disable)) return e.read("yandex_login") ? this.trigger("GDPR-skip-login") : ja() ? "0" === h ? this.trigger("GDPR-skip") : n.isSafariWebView() || n.isAndroidWebView() ? this.trigger("GDPR-skip-wv") : this.trigger("GDPR-skip-na") : this.trigger("GDPR-skip-domain"), this.realise(q, b);
                this.globalConfig.set(this.globalKey, function (a, c) {
                    ...
                    b.size + d < k.MAX_SIZE ? (b.push(a), b.size += d) : f.warning("GDPR buffer is exceeded")
                });
                a.hit(function (a) {
                    if (a.params.eu || l || k.enabled) if (k.frameConnector &&
                    k.frameConnector.addHandler("isYandex", function () {
                        return {type: "isYandex", isYandex: ja()}
                    }), k.frameConnector.isIframe) {
                        k.frameConnector.sendToParents({type: "isYandex"}, function (a, c) {
                            var d = !1;
                            clearTimeout(g);
                            c[0].isYandex ? (k.trigger("GDPR-frame-ya"), k.frameConnector.addHandler("GDPR-ok", function () {
                                d || (e.create("gdpr", "0", 525600), k.realise(c, b), d = !0)
                            }), k.frameConnector.addHandler("GDPR-cancel", function () {
                                e.create("gdpr", "1")
                            })) : (k.trigger("GDPR-frame-noya"), k.realise(c, b))
                        });
                        var g = f.setTimeout(function () {
                            k.trigger("GDPR-frame-skip");
                            k.realise(q, b)
                        }, 2E3)
                    } else k.askGDPR(h, d, c, q, b, e); else return a.params.eu ? k.trigger("GDPR-skip-eu-na") : k.trigger("GDPR-eu-skip"), k.realise(q, b)
                })
            }
        });
    ea.globalKey = "f1";
    ea.cookie = new F({skipPrefix: !0});
    ea.getState = function (a) {
        var b = ea.cookie.read("gdpr");
        a = f.reduce(function (a, b) {
            b.ymetrikaEvent && f.inArray($a, b.ymetrikaEvent.type) && a.push(f.arrayIndexOf($a, b.ymetrikaEvent.type));
            return a
        }, [], a.get("dataLayer"));
        return a.length ? (a = a.join(","), b && (a += "-" + (f.inArray(["0", "1"], b) ? b : "2")), a) : ""
    };
    var Tb = {
        init: function (a,
                        b) {
    ...
    n.isPrivate = u(function (a) {
        var b = f.bind(a, null, 0), c = f.bind(a, null, 1);
        if (f.isFunction(g.webkitRequestFileSystem)) return g.webkitRequestFileSystem(0, 0, b,
            c);
        if (n.isFF()) try {
            if (g.indexedDB && f.isFunction(g.indexedDB.open)) {
            ...
            b()
        } else if (n.isSafari() && f.isFunction(g.openDatabase)) try {
    ...
    n.getHref = function (a) {
        if (!a) return "";
        a = a.href;
        return f.isString(a) ? "" + a : "[object SVGAnimatedString]" === f.toString(a) ? "" + a.baseVal : ""
    };
    var R = {};
    R._cookie = new F({onlyCurrentDomain: !0});
    R._check = u(function () {
        return -1 < g.location.href.indexOf("_ym_debug\x3d1") || g._ym_debug || "1" ===
            R._cookie.read("debug")
    });
    R.enabled = R._check();
    R.log = u(function () {
        (-1 < J.href.indexOf("_ym_debug\x3d1") || g._ym_debug) && this._cookie.create("debug", "1");
        g.console && console.log && this._check() && (R.enabled = !0, console.log.apply(console, arguments))
    }, "DebugConsole.log");
    var Ub = A.inherit({
        resource: "clmap", retry: !0, transports: [Q], sendClick: function (a, b, c, d) {
        ...
        _handler: function (a) {
            a = {el: G.getTarget(a), pos: G.getPos(a), button: G.getMouseButton(a), time: +new Date};
            if (this._isTrackingClick(a)) {
                ...
                this._sender.sendClick(f.trim(c, Aa), b.join(":"));
                this._lastClick = a
            }
        },
        ...
        injectHash: {
            ...
            f.forEachKey(this.injectHash, function (b) {
                a[ca + ("" + f.fnv32a(b))] = this.injectHash[b]
            }, this);
            return a
            ...
            this.globalConfig.get(this.REMOTE_CONTROL) || (this.globalConfig.set(this.REMOTE_CONTROL, !0), Ma.superclass._initComponent.apply(this,
                arguments), this._executedMsgs = {}, k.on(g, "message", this._onMessage, this), a.length && (this.globalConfig.set("oo", !0), this.globalConfig.get("stopRecoder", function () {
            })(), f.arrayEvery(a, function (a) {
                p.loadScript({src: a}, g);
                return 1
            })))
        }, _buildRemoteIframe: function (a) {
            var b = f.getNativeFunction("createElement", h)("div"), c = p.getBody() || h.documentElement;
            if (c) {
        ...
        match: function () {
            this.enabled() && k.ready(function () {
                ...
                a.onload = function () {
                    na.save("cm", x.getMinutes());
                    p.removeNode(a)
                };
                a.style.display = "none";
                a.src = E.protocol + "//" + E.host + "/metrika/watch_match.html";
                h.documentElement.appendChild(a)
            })
        }, enabled: function () {
            return 1440 < x.getMinutes() - na.getNum("cm") && "tr" === f.getTld()
        }
    };
    u(function () {
        (function (a) {
            ...
            b.c = c;
            b.d = function (a, c, f) {
                b.o(a, c) || Object.defineProperty(a, c, {configurable: !1, enumerable: !0, get: f})
            };
            b.n = function (a) {
            ...
            0: function (a, b, c) {
                ...
                b.__esModule = !0;
                var d =
                    c(5), e = c(9), f = c(34), k = c(6), m = h.body, n = h.documentElement;
                b.detectAd = function () {
                    var a = g.pageYOffset || n.scrollTop || m.scrollTop,
                        b = g.pageXOffset || n.scrollLeft || m.scrollLeft, c = n.clientTop || m.clientTop || 0,
                        h = n.clientLeft || m.clientLeft || 0, l = n.scrollWidth || n.offsetWidth || g.innerWidth,
                        r = n.scrollHeight || n.offsetHeight || g.innerHeight, p = k.getFrienlyWindowsTree(g), v = [];
                    k.windowsTreeEach(p, function (a) {
                        var b = a.window, c = a.parent,
                            f = 0 < d.getParentFriendlyIFrames(b.document.documentElement).length,
                            g = e.getAdsInWindow(b,
                                {isInIFrame: f});
                        f = g.adElements;
                        g = g.iframeProviders;
                        if (c) {
                            var h = b.frameElement, k = v.filter(function (a) {
                        ...
                        v.push({windowsTree: a, adElements: f})
                    });
                    ...
                    v.forEach(function (a) {
                        ...
                        a.forEach(function (a) {
                            var b = a.element;
                            Oa.push({provider: a.provider, element: c ? e : b})
                        })
                    });
                    Oa.forEach(function (d) {
                        ...
                        var k = e.clientWidth;
                        e = e.clientHeight;
                        var m = f + k, n = g + e, q = 0 > f ? 0 : f < l ? f : l, p = 0 > g ? 0 : g < r ? g : r;
                        100 <= ((m > l ? l : m > q ? m : q) - q) * ((n > r ? r : n > p ? n : p) - p) && u.push({
                            top: g,
                            left: f,
                            width: k,
                            height: e,
            ...
            5: function (a, b, c) {
                ...
                b.getAdsInWindow = function (a, b) {
                    ...
                    var f = b.isInIFrame, g = a.document.body, h = d.listToArray(g.querySelectorAll("img")),
                        ...
                        l = d.listToArray(g.querySelectorAll("script")), n = d.listToArray(g.querySelectorAll("div")),
                        r = [], p = [], v = d.listToArray(g.querySelectorAll("yatag")),
                    ...
                    return {adElements: r, iframeProviders: p}
                }
            }
        })
    }, "", !0)();
    var Xb = {
                        ...
                        a.sendParams({
                            __ym: {
                                ads: {
                                    ...
                                    }, p: {w: e.width, h: e.height}, a: f.map(function (a) {
            ...
            checkChildrenData: function (a,
                                         b) {
                f.arrayEvery(this.dataToSend.childs, function (c) {
                    -1 == f.arrayIndexOf(c.tryTo, b.counterId) && (c.tryTo.push(b.counterId), f.mixin(c.data, {toCounter: b.counterId}), this.sendToIframe(a, c.data, function () {
            ...
            genMessage: function (a, b) {
                ...
                return {meta: c, string: da.stringify(d)}
            },
            ...
            sendToChildren: function (a, b, c) {
                var d =
                    this, e = this.dataToSend.childs.push({
                    sendedTo: [],
                    tryTo: [],
                    callback: b ? f.bind(b, c || this) : !1,
                    data: a
                }) - 1;
                f.forEachKey(this.childs, function (a) {
                    this.dataToSend.childs[e].tryTo.push(a);
                    return 1
                }, this);
                f.keys(this.childs).length && f.forEachKey(this.childs, function (b) {
                    this.sendToIframe(d.childs[b].window, f.mixin(a, {toCounter: b}), function (a) {
                        this.dataToSend.childs[e].sendedTo.push(b);
                        this.dataToSend.childs[e].callback && this.dataToSend.childs[e].callback(a)
                    }, this)
                }, this)
            },
            sendToParents: function (a, b, c) {
                var d = this.dataToSend.parents.push({
                    sendedTo: [],
                    tryTo: [], callback: b ? f.bind(b, c || this) : !1, data: a
                }) - 1;
            ...
            _initComponent: function () {
                var a =
                    g.document.getElementsByTagName("iframe"), b = 0;
                wb.superclass._initComponent.apply(this, arguments);
        ...
        }), J = y(), Ia = x.getTimezone(), Ja = x.getTimestamp(), W = g.screen, Mb = 64, Aa = n.isIE() ? 512 : 2048,
        Nb = n.isIE() ? 512 : 2048, Wa = n.isIE() ? 100 : 400, ub = 100, ib = "noindex",
        xb = /\.(3gp|7z|aac|ac3|acs|ai|avi|ape|apk|asf|bmp|bz2|cab|cdr|crc32|css|csv|cue|divx|dmg|djvu?|doc(x|m|b)?|emf|eps|exe|flac?|flv|iso|swf|gif|t?gz|jpe?g?|js|m3u8?|m4a|mp(3|4|e?g?)|m4v|md5|mkv|mov|msi|ods|og(g|m|v)|psd|rar|rss|rtf|sea|sfv|sit|sha1|svg|tar|tif?f|torrent|ts|txt|vob|wave?|wma|wmv|wmf|webm|ppt(x|m|b)?|xls(x|m|b)?|pdf|phps|png|xpi|g?zip)$/i,
        Yb = +new Date, kb, ab, ca = function () {
            return "1332"
        }();
    v.init().setSafe("counters", {}).setSafe("hitParam", {}).setSafe("counterNum", 0).setSafe("dataLayer", []).setSafe("hitId", f.random(1, 1073741824)).setSafe("_globalMetrikaHitId", f.random()).setSafe("v", ca);
        ...
        return u(function () {
            ...
            function l(a, b) {
                ...
                if (a && "string" != typeof a && a.length) for (d = 0; d < a.length; d++) {
                    ...
                    f = f.slice(1);
                    if ("#" == g) {
                        if (g = h.getElementById(f)) c = !0, b && Y.unshift([g, g.innerHTML]), g.innerHTML = e
                    } else if ("." == g) for (g = p.getElementsByClassName(f), f = 0; f < g.length; f++) {
                        c = !0;
                        var k = g[f], l = e;
                        b && Y.unshift([k, k.innerHTML]);
                        k.innerHTML = l
                    }
                }
                return c
            ...
            function m() {
                var a;
                for (a = 0; a < Y.length; a++) Y[a][0].innerHTML = Y[a][1]
            }
            ...
            function E(a, b) {
                ...
                d && (d = -1 < d.indexOf(";") ? f.safeDecodeURIComponent(d) :
                    Ua.decode(P.decode(d.replace(/[-*_]/g, function (a) {
                        return {"*": "+", "-": "/", _: "\x3d"}[a] || a
                    }))));
            ...
            function t(w) {
                var D = !1;
                M || (A.initCookie(), sb.init(v));
                n.isAndroidWebView() || (ma.initPU(ha, v), ma.initPP(v));
                A.retransmit(v);
                Ka && Tb.init(Ka, pa);
                Wa.init(Ba);
                if (v.get("hitParam")[Z]) {
                    if (1 != c || v.get("counters")[Z]) return !1;
                    D = !0
                }
                v.get("counters")[Z] = e;
                v.get("hitParam")[Z] = 1;
                ...
                e._webvisor = z.webvisor || !1;
                e._directCampaign = z.directCampaign;
                z.trackHash && ua(!0);
                if (!D) {
                    Da = new tb({
                        protocol: "https:",
                    ...
                    var q = function (D) {
                        ...
                        q.sendHit({
                            ...
                            ts: Ja,
                            tz: Ia,
                            callback: function (d, w) {
                                var n;
                                d = d || {};
                                (n = "0" !== d.pcs) || ma.initZZ();
                                d.eu !== C && v.set("isEU", d.eu);
                                na.init(w);
                                Wb.match();
                                Qb.sync(a, c, n, v);
                                R.log("PageView. Counter ", a, ". URL: ", J.href, ". Referrer: " + h.referrer, ". Params: ", b);
                                ab || (ab = +new Date);
                                d.webvisor && (d.webvisor.isEU = v.get("isEU"));
                                if (!e.isDestructing()) {
                                    Da.start(d.webvisor, d.publisher);
                                    var p = d.mp2;
                                    n = new F({counterId: a});
                                    n.erase("mp2_substs");
                                    if (p) {
                                        b:{
                                            var q = p.conditions;
                                            var aa;
                                            if (q && q.length) for (aa = 0; aa < q.length; aa++) {
                                                var t = q[aa];
                                                if ("ref" == t.type) t = r(t); else if ("adv" == t.type) {
                                                    var I;
                                                    var u = t;
                                                    var ba = g.Ya._metrika.counter._directCampaign;
                                                    var U = u.ServiceNamePattern;
                                                    var x = u.RefererPattern;
                                                    t = ba ? u.direct_orders : u.direct_camp;
                                                    var z = h.referrer, y = ka.parse(J.search), A = E(J.search,
                                                        J.hash), B = {};
                                                    var V = ["source", "medium", "campaign", "term", "content"];
                                                    for (I = 0; I < V.length; I++) y["utm_" + V[I]] && (B[V[I]] = y["utm_" + V[I]]);
                                                    var G = ba ? "direct.yandex.ru" : A && A.service || B.source;
                                                    I = !1;
                                                    if (!I && U && U.length) for (V = 0; V < U.length; V++) if ((new RegExp(U[V], "i")).test(G)) {
                                                        I = !0;
                                                        break
                                                    }
                                                    if (!I && !u.yandex_direct && x && x.length) for (U = 0; U < x.length; U++) if ((new RegExp(x[U], "i")).test(z)) {
                                                        I = !0;
                                                        break
                                                    }
                                                    !I && u.google_adwords && y.gclid && (I = !0);
                                                    if (I && t && t.length && (I = !1, ba = ba || A && A.campaign || B && B.campaign)) for (u = 0; u < t.length; u++) if (t[u] ==
                                                        ba) {
                                                        I = !0;
                                                        break
                                                    }
                                                ...
                                                if (t) {
                                                    q[aa].track_id && n.create("mp2_track", q[aa].track_id, 43200);
                                                    break b
                                                }
                                            }
                                        }
                                        q = n.read("mp2_track");
                                        p = p.substs && p.substs[q];
                                        q && p ? (n.create("mp2_substs", f.toJSON(p)), n = l(p), e.params("__ym", n ? "mp_trackid" : "mp_trackid_bad", q)) : m()
                                    } else m();
                ...
                Q(!1);
                k.on(h, "click", ca);
                0 != f.keys(z).length && (Ma && Ma.initUserLayer(), z.enableAll ? (Q(!0), S(!0), W()) : (z.clickmap && S(z.clickmap), z.trackLinks && Q(z.trackLinks), z.accurateTrackBounce &&
                W(z.accurateTrackBounce)), z.triggerEvent && f.async(function () {
                    G.dispatchCustomEvent("yacounter" + a + "inited")
                }, this, "yacounterInit"))
            }
            ...
            function ca(a) {
                e._trackLinks && e._trackLinks.on && ja(a)
            }

            function ja(a) {
                var b =
                    n.findTarget(a), c = n.getHref(b);
                if (c) {
                    a = !1;
                    var d = c ? c.split(/\?/)[0] : "";
                    var e = function (a) {
                    ...
                    if (xb.test(d) || xb.test(c) || qb(c, sa) || qb(d, sa)) a = !0;
                    var g = p.classNameExists(b, "ym-disable-tracklink");
                    d = p.classNameExists(b, "ym-external-link");
                    g || (g = {
                        ln: !0,
                        dl: a
                    }, d ? e(g) : (d = b.hostname || f.parseUrl(b.href).hostname || "", Fb(y().hostname, d) ? a ? (g.ln = !1, e(g)) : (a = pb(b)) && a != c && Xa.set("il", f.trim(a, ub)) : c && -1 != c.search(/^ *(data|javascript):/i) || (g.ut = ib, e(g))))
                }
            }
            ...
            function la(a, b) {
                ...
                function e(a) {
                    var b;
                    for (b = 0; b <
                    t.length; b += 3) if (a) k.on(t[b], t[b + 1], t[b + 2], {name: "tabTrack"}); else k.un(t[b], t[b + 1], t[b + 2])
                }

                var l = !1, m = !1, w = !0, p = 0, D = +new Date, q = null, r = !1;
            ...
            function W(b) {
                var c = z.referrer ? Ea : h.referrer, d = z.url ? L : y().href;
                "number" !== typeof b && (b = 15E3);
                if (!e._isAccurateTrackBounce) {
                    e._isAccurateTrackBounce =
                        !0;
                    var f = new T({counterId: a});
                    var g = f.get("lastHit");
                    f.set("lastHit", x.getMs());
                    ((f = f.get("lastHit")) && (!g || g < f - 18E5) || !Gb(c, d) || .1 > Math.random()) && la(function () {
                        e.notBounce()
                    }, b)
                }
            }
            ...
            function ra(a) {
                ...
                (function ba() {
                    var d = b();
                    d !== c && (a(), c = d);
                    ta = f.setTimeout(ba, 200, "trackHash")
                })()
            }

            function ua(a) {
                if (!1 === a) ia && ("onhashchange" in g ? k.un(g, "hashchange", Pa) : f.clearTimeout(ta),
                    ia = !1); else if (a = Pa, !ia) {
                    if ("onhashchange" in g) k.on(g, "hashchange", a); else ra(a);
                    ia = !0
                }
                N.setTrackHash(ia);
                e._trackHash = ia
            ...
            function Pa() {
                var a = {ut: va, ad: 1 == c && g.Ya && g.Ya.Direct, wh: !0, saveRef: !0, pv: !0};
                za = Va.lastReferrer = Aa;
                N.sendAjaxHit({url: z.url ? L : y().href, title: p.getDocumentTitle(), referrer: za, modes: a});
                Aa = y().href
            }

            function Qa(a, b, c) {
                a = Za.parseValidate(a, b);
                b = [];
            ...
            var va = "", z = {},
                za = "", Aa = Va.lastReferrer = J.href, Ba = 0, Da;
            v.setSafe("counter", e);
            qa && u(function () {
                throw qa.error;
            }, "include." + qa.scope)();
            ...
            if (!g["disableYaCounter" + a]) {
                ...
                c = c || 0;
                var Z = a + ":" + c;
                if (v.get("counters")[Z]) return R.log("Duplicate counter " + Z + " initialization"), v.get("counters")[Z];
                var pa = v.get("hitId");
                var ha = new wb({counterId: a, hid: pa});
                v.set("counterNum", v.get("counterNum") + 1);
                var La = v.get("counterNum");
                var N = new wa({
                    protocol: "https:", counterType: c, counterId: a,
                    hitId: pa, counter: e, globalConfig: v, counterNum: La
                });
                var Wa = {
                    init: function (a) {
                        if (g.performance && "function" === typeof performance.getEntries && (a === C && (a = 1), !(Math.random() >= a))) {
                            ...
                            f.keys(c).length && (new oa).logParams({timings8: c})
                        }
                    }
                };
                Ba = 24226447 == a ? 1 : .002;
                e.replacePhones = q(function () {
                    var b, c;
                    try {
                        (b = (new F({counterId: a})).read("mp2_substs")) && (c = da.parse(b)) && l(c, !0)
                    } catch (aa) {
                    }
                    return e
                }, "counter.replacePhones");
                e.reachGoal = q(function (b, c, d, f) {
                    2 <=
                    arguments.length && "function" === typeof c && (f = d, d = c, c = C);
                    R.log("Reach goal. Counter: " + a + ". Goal id: " + b + ". Params: ", c);
                    N.sendGoal(b, {url: z.url ? L : y().href, vParams: c, callback: d, ctx: f});
                    return e
                }, "counter.reachGoal");
                e.trackLinks = q(function (a) {
                    Q(a);
                    return e
                }, "counter.trackLinks");
                var Xa = new T({counterId: a});
                e.hit = q(function (b, c, d, g, h, k) {
                    b ? (f.isObject(c) && (d = c.referer, g = c.params, h = c.callback, k = c.ctx, c = c.title), L = b, R.log("PageView. Counter " + a, ". URL: " + b, ". Referrer: " + d, ". Params: ", g), N.sendHit({
                        url: b,
                        title: c, referrer: d, vParams: g, callback: h, ctx: k
                    })) : f.warning("Empty hit url");
                    return e
                }, "counter.hit");
                e.params = q(function (b) {
                    ...
                    if (b) {
                        ...
                        (d = -1 !== f.arrayIndexOf(f.keys(g[0]), "__ym") && g[0].__ym.user_id) ?
                            R.log('Set user id "' + g[0].__ym.user_id + '"') : R.log((c ? "User p" : "P") + "arams. Counter " + a + ". Params: ", g[0]);
                        N.sendParams(g[0], h, k, z.url ? L : y().href)
                ...
                e.notBounce = q(function (a) {
                    var b = 0;
                    a = a || {};
                    kb && ab && (b = ab - kb);
                    N.sendNotBounce(b, {url: z.url ? L : y().href, callback: a.callback, ctx: a.ctx});
                    return e
                }, "counter.notBounce");
                var sa = [];
                e.addFileExtension = q(function (a) {
                    if (!a) return f.warning("Empty extension"),
                        e;
                    "string" === typeof a ? sa.push(a) : sa = sa.concat(a);
                    return e
                });
                ...
                e.accurateTrackBounce = q(function (a) {
                    W(a);
                    return e
                });
                var ta = null;
                var ia = !1;
                e.trackHash = q(function (a) {
                    ua(a);
                    return e
                });
                var Za = {
                    requiredEcommerceFields: ["currency", "goods"], parseValidate: function (a, b) {
                        ...
                        for (d in b) b.hasOwnProperty(d) && -1 ===
                        f.arrayIndexOf(this.requiredEcommerceFields, d) && (c[a].actionField || (c[a].actionField = {}), c[a].actionField[d] = b[d]);
                        ...
                        if (f.isObject(b)) switch (a) {
                            ...
                            case "remove":
                                ...
                                })) || (d = "All items in 'goods' should be objects and contain 'id' or 'name' field") : d =
                ...
                e.ecommerceDetail = q(function (a, b) {
                    Qa("detail", a, b);
                    return e
                }, "ecommerce.detail");
                e.ecommerceAdd = q(function (a, b) {
                    Qa("add", a, b);
                    return e
                }, "ecommerce.add");
                e.ecommerceRemove = q(function (a, b) {
                    Qa("remove", a, b);
                    return e
                }, "ecommerce.remove");
                e.ecommercePurchase =
                ...
                e.destruct = q(function () {
                    ...
                    S(!1);
                    try {
                        delete g["yaCounter" + a], delete v.get("counters")[Z], delete v.get("hitParam")[Z]
                    } catch (w) {
                    }
                });
                ...
                Xb.init(N);
                e._performanceTiming = rb;
                if (a) {
                    var Ma = new fa({
                        counter: e, counterId: a, globalConfig: v, frameConnector: ha,
                        prefsEcommerce: z.ecommerce, prefsUseDataLayer: z.useDataLayer
                    });
                    if ("prerender" === h.webkitVisibilityState || "prerender" === h.visibilityState) {
                        N.sendPrerenderHit({url: L, title: p.getDocumentTitle(), referrer: h.referrer});
                        var ya = function () {
                            "prerender" !== h.webkitVisibilityState && "prerender" !== h.visibilityState && (k.un(h, "webkitvisibilitychange,visibilitychange", ya), B(!0))
                        };
                        k.on(h, "webkitvisibilitychange,visibilitychange", ya)
                    } else B(!1)
                }
            }
        }, "init")()
    };
    new Ma({globalConfig: v});
    g.Ya.Metrika.counters = function () {
        var a =
            [];
        f.forEachKey(v.get("counters"), function (b, c) {
            var d = b.split(":");
            a.push({
                id: +d[0],
                type: +d[1],
    ...
    (function () {
        ...
        "function" == typeof b && b();
        if ("object" == typeof c) for (b =
                                           0; b < c.length; b++) if (d = c[b]) c[b] = null, d();
